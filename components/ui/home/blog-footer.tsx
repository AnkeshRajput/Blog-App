      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="md:col-span-2">
            <h2 className="text-3xl font-extrabold">
              <span className="bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-400 dark:to-indigo-400 bg-clip-text text-transparent hover:drop-shadow-[0_0_10px_rgba(129,140,248,0.5)] transition-all duration-300 ease-in-out">
                ByteCode
              </span>
            ...
            <div className="mt-6 flex gap-3">
              {[Twitter, Github, LinkedinIcon].map((Icon, idx) => (
                ...
                >
                  <Icon className="h-5 w-5 text-muted-foreground hover:text-indigo-400" />
                </Button>
              ))}
            </div>
          </div>
            ...
            <form className="space-y-4">
              <div className="relative">
                <Input
                  ...
                  className="pl-12 py-5 rounded-lg shadow-inner bg-white/5 border border-white/10 backdrop-blur-sm text-white focus:ring-2 focus:ring-indigo-500"
                />
                <Mail className="h-5 w-5 absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground" />
              </div>
              <Button type="submit" className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:brightness-110 hover:shadow-lg transition text-white font-semibold">
                Subscribe
              </Button>
            </form>
          </div>
        ...
        <div className="mt-16 border-t border-white/10 pt-8 text-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} <span className="font-semibold">ByteCode</span>. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
