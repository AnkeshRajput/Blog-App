...
export async function BlogDashboard() {
  try {
    ...
    return (
      <main className="flex-1 p-4 md:p-8">
        <div className="rounded-xl border border-yellow-300/40 bg-yellow-50 p-6 text-yellow-900">
          <h2 className="text-lg font-semibold">Dashboard unavailable</h2>
          <p className="text-sm opacity-80">
            Can’t connect to the database right now. Please check your
            DATABASE_URL or try again later.
          </p>
        </div>
      </main>
    );
